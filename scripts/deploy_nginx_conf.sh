...
-e "s|{{SERVICE_EDC_UI_PORT}}|$SERVICE_EDC_UI_PORT|g" \
-e "s|{{SERVICE_LINE_MENU_API_PORT}}|$SERVICE_LINE_MENU_API_PORT|g" \
-e "s|{{SERVICE_LINE_MENU_WEB_PORT}}|$SERVICE_LINE_MENU_WEB_PORT|g" \
-e "s|{{SERVICE_LINE_MENU_DELIVERY_PORT}}|$SERVICE_LINE_MENU_DELIVERY_PORT|g" \
-e "s|{{SERVICE_BACKOFFICE2_API_PORT}}|$SERVICE_BACKOFFICE2_API_PORT|g" \
-e "s|{{SERVICE_BACKOFFICE2_UI_PORT}}|$SERVICE_BACKOFFICE2_UI_PORT|g" \
-e "s|{{SERVICE_RESERVATION_API_PORT}}|$SERVICE_RESERVATION_API_PORT|g" \
-e "s|{{SERVICE_RESERVATION_UI_BACKOFFICE_PORT}}|$SERVICE_RESERVATION_UI_BACKOFFICE_PORT|g" \
-e "s|{{SERVICE_RESERVATION_UI_FORM_PORT}}|$SERVICE_RESERVATION_UI_FORM_PORT|g" \
...
ln -s /etc/nginx/sites-available/bzr_v5.conf /etc/nginx/sites-enabled/bzr_v5.conf
